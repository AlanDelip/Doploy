...
public class SampleServiceTest {
    ...
    public void testGetSample() {
        ...
        when(sampleDao.findById(Long.valueOf("2")))
    ...
    public void testPut() {
        ...
        when(sampleDao.findById(Long.valueOf("2")))
                .thenReturn(Optional.of(successData));
        ...
        when(sampleDao.findById(Long.valueOf("3")))
                .thenReturn(Optional.of(failData));
        assertFalse(sampleService.put(3, "fail", "fail"));

        //modify success
        when(sampleDao.findById(Long.valueOf("4")))
                .thenReturn(Optional.of(successData));
        when(sampleDao.save(successData))
                .thenReturn(new SampleData());
